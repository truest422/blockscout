defmodule Explorer.Chain.Address.TokenBalance do
   ...
   *  `token_id` - The token_id of the transferred token (applicable for SVC-1155 and SVC-721 tokens)
  ...
  ignores the burn_address for tokens SVC-721 since the most tokens SVC-721 don't allow get the
  ...
  def unfetched_token_balances do
    from(
      ...
      where:
        ((tb.address_hash != ^@burn_address_hash and t.type == "SVC-721") or t.type == "SVC-20" or t.type == "SVC-1155") and
