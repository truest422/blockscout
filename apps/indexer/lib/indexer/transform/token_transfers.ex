defmodule Indexer.Transform.TokenTransfers do
  @moduledoc """
  Helper functions for transforming data for SVC-20 and SVC-721 token transfers.
  """
  ...
  @token_types_priority_order ["SVC-20", "SVC-721", "SVC-1155"]
  ...
  # SVC-721 token transfer with topics as addresses
  ...
  # SVC-721 token transfer with info in data field instead of in log topics
  defp parse_params(
         %{
           second_topic: nil,
           third_topic: nil,
